    ...
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <header className="flex flex-col items-center justify-center py-10 bg-black">
        ...
        <div className="w-full max-w-4xl px-4">
          <video className="w-full rounded-xl shadow-2xl border border-gray-700" autoPlay loop muted playsInline>
      ...
      <main className="max-w-7xl mx-auto px-4 py-12">
        <h2 className="text-3xl font-bold text-center mb-10 border-b border-gray-700 pb-4">New Arrivals</h2>
        
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {/* ITEM 1 */}
          <div className="bg-gray-800 rounded-lg overflow-hidden shadow-lg">
            <img src="/tigersharkjewelryIMG_8987.jpg" alt="Gold Custom Piece" className="w-full h-64 object-cover"/>
            <div className="p-4">
          ...
          {/* ITEM 2 */}
          <div className="bg-gray-800 rounded-lg overflow-hidden shadow-lg">
            <img src="/tigersharkjewelryIMG_8989_2.jpg" alt="Silver Chain" className="w-full h-64 object-cover"/>
            <div className="p-4">
          ...
          {/* ITEM 3 */}
          <div className="bg-gray-800 rounded-lg overflow-hidden shadow-lg">
            <img src="/tigersharkjewelryIMG_8991_4.jpg" alt="Premium Pendant" className="w-full h-64 object-cover"/>
            <div className="p-4">
